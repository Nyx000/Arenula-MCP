...
internal static class ToolRegistry
{
    ...
    {
        name = "terrain",
        description = "Create and edit terrain: configure dimensions, paint surface materials, and manage heightmap state. Use 'create' to add a terrain with specified world-size dimensions. Use 'paint_material' to apply terrain material layers at world positions with a brush radius and strength. Always call 'sync' after a batch of terrain edits to persist changes between CPU and GPU textures. Terrain APIs require verification during implementation — heightmap editing granularity depends on available engine APIs.",
        inputSchema = new
        {
            type = "object",
            properties = new Dictionary<string, object>
