    ...
    internal static readonly object Effects = new
    {
        ...
        inputSchema = new
        {
            ...
            properties = new Dictionary<string, object>
            {
                ...
                ["size"] = new { type = "string", description = "Size as 'w,h'. Used by: create (type=sprite), configure_sprite." },
                ["color"] = new { type = "string", description = "Color as 'r,g,b,a' (0-255). Used by: create (type=sprite), configure_sprite." },
                ...
                ["animation"] = new { type = "string", description = "Starting animation name. Used by: create (type=sprite), configure_sprite." },
